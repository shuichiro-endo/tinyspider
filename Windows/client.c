...
int create_map_client_receive_message(struct map_client_receive_message **map, HANDLE *handle)
{
    NTSTATUS status;
    LONG previousCount_mutex = 0;

    status = NtCreateMutant(handle, 0x1F0001, NULL, false);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] create_map_client_receive_message NtCreateMutant error: %x\n", status);
#endif
        return -1;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] create_map_client_receive_message NtWaitForSingleObject error: %x\n", status);
#endif
        return -1;
    }
    ...
    *map = (struct map_client_receive_message *)calloc(1, sizeof(struct map_client_receive_message));
    ...
    {
#ifdef _DEBUG
        printf("[-] create_map_client_receive_message NtReleaseMutant error: %x\n", status);
#endif
        return -1;
    }
...
void insert_map_node_client_receive_message(struct map_client_receive_message *map, HANDLE handle, uint32_t message_id, struct spider_message *message)
{
    NTSTATUS status;
    LONG previousCount_mutex = 0;
    ...
    {
#ifdef _DEBUG
        printf("[-] insert_map_node_client_receive_message NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] insert_map_node_client_receive_message NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}

struct map_node_client_receive_message *search_map_node_client_receive_message(struct map_client_receive_message *map, HANDLE handle, uint32_t message_id)
{
    NTSTATUS status;
    LONG previousCount_mutex = 0;
    ...
    {
#ifdef _DEBUG
        printf("[-] search_map_node_client_receive_message NtWaitForSingleObject error: %x\n", status);
#endif
        return NULL;
    }
    ...
    while(current != NULL)
    {
        if(current->message_id == message_id)
        {
            ...
            {
#ifdef _DEBUG
                printf("[-] search_map_node_client_receive_message NtReleaseMutant error: %x\n", status);
#endif
                return NULL;
            }
...
void delete_map_node_client_receive_message(struct map_client_receive_message *map, HANDLE handle, uint32_t message_id)
{
    NTSTATUS status;
    LONG previousCount_mutex = 0;
    struct map_node_client_receive_message *current = NULL;
    ...
    {
#ifdef _DEBUG
        printf("[-] delete_map_node_client_receive_message NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] delete_map_node_client_receive_message NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}

void free_map_client_receive_message(struct map_client_receive_message *map, HANDLE handle)
{
    NTSTATUS status;
    LONG previousCount_mutex = 0;
    struct map_node_client_receive_message *current = NULL;
    ...
    {
#ifdef _DEBUG
        printf("[-] free_map_client_receive_message NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] free_map_client_receive_message NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}

void insert_map_node_client_receive_message_thread(struct function_args *args)
{
    struct insert_map_node_client_receive_message_thread_args *insert_map_node_client_receive_message_thread_args = (struct insert_map_node_client_receive_message_thread_args *)args->args;
    struct client_data *client = insert_map_node_client_receive_message_thread_args->client;
    uint32_t message_id = insert_map_node_client_receive_message_thread_args->message_id;
    struct spider_message *message = insert_map_node_client_receive_message_thread_args->message;
    struct map_node_thread *thread = NULL;

    free(insert_map_node_client_receive_message_thread_args);

    insert_map_node_client_receive_message(client->m_client_receive_message, client->mutex_m_client_receive_message, message_id, message);
    ...
    {
#ifdef _DEBUG
        printf("[-] insert_map_node_client_receive_message_thread cannot close handle\n");
#endif
    }
...
void push_socks5_message_client(struct function_args *args)
{
    struct push_message_queue_args_client *push_message_queue_args_client = (struct push_message_queue_args_client *)args->args;
    struct client_data *client = push_message_queue_args_client->client;
    struct spider_message *message = push_message_queue_args_client->message;
    struct map_node_thread *thread = NULL;

    free(push_message_queue_args_client);
    ...
    {
#ifdef _DEBUG
        printf("[-] push_socks5_message_client cannot close handle\n");
#endif
    }
...
struct spider_message *pop_socks5_message_client_timeout(struct client_data *client, long long tv_sec, long long tv_usec)
{
...
int32_t recv_message_client(struct client_data *client, char *buffer, int32_t buffer_size, long long tv_sec, long long tv_usec, bool register_server_id_flag)
{
    int32_t ret = 0;
    int32_t rec = 0;
    struct spider_message *socks5_message = NULL;
...
int32_t send_message_client(struct client_data *client, char *buffer, int32_t buffer_length, long long tv_sec, long long tv_usec)
{
    int32_t ret = 0;
    int32_t sen = 0;
    struct spider_message *socks5_message = NULL;
...
int recv_receive_message_client(struct client_data *client, uint32_t message_id, long long tv_sec, long long tv_usec)
{
    struct map_node_client_receive_message *node = NULL;
    struct spider_message *socks5_message = NULL;
    struct timeval start;
    ...
    while(1)
    {
        node = search_map_node_client_receive_message(client->m_client_receive_message, client->mutex_m_client_receive_message, message_id);
        if(node != NULL)
        {
            ...
            if(socks5_message != NULL)
            {
                ...
                {
                    delete_map_node_client_receive_message(client->m_client_receive_message, client->mutex_m_client_receive_message, message_id);
...
int send_receive_message_client(struct client_data *client, uint32_t message_id, uint8_t receive_flag, uint8_t receive_result, long long tv_sec, long long tv_usec)
{
...
void forwarder_recv_data_client(void *args)
{
    ...
    while(1)
    {
        ...
        if(ret > 0)
        {
            ...
            rec = recv(client->client_sock, buffer, SPIDER_MESSAGE_DATA_SIZE, 0);
            if(rec == SOCKET_ERROR)
            {
                err = WSAGetLastError();
...
#ifdef _DEBUG
                printf("[-] [client -> client] forwarder_recv_data_client recv error: %d\n", err);
#endif
...
void forwarder_send_data_client(void *args)
{
    struct client_data *client = (struct client_data *)args;
    struct map_node_thread *thread = NULL;
    int ret = 0;
        ...
        if(ret > 0)
        {
            ...
            if(rec > 0)
            {
                if(client->recv_message_id == client->next_recv_message_id)
                {
                    ...
                    while(len > 0)
                    {
                        sen = send(client->client_sock, buffer + send_length, len, 0);
                        if(sen == SOCKET_ERROR)
                        {
                            err = WSAGetLastError();
                            if(err == WSAEWOULDBLOCK)
...
{
    NTSTATUS status;
    HANDLE handle_forwarder_recv_data_client = NULL;
    HANDLE handle_forwarder_send_data_client = NULL;

    status = NtCreateThreadEx(&handle_forwarder_recv_data_client, THREAD_ALL_ACCESS, NULL, NtCurrentProcess(), (void *)forwarder_recv_data_client, (void *)client, 0, 0, 0, 0, NULL);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] forwarder_client NtCreateThreadEx forwarder_recv_data_client error: %x\n", status);
#endif
    }

    status = NtCreateThreadEx(&handle_forwarder_send_data_client, THREAD_ALL_ACCESS, NULL, NtCurrentProcess(), (void *)forwarder_send_data_client, (void *)client, 0, 0, 0, 0, NULL);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] forwarder_client NtCreateThreadEx forwarder_send_data_client error: %x\n", status);
#endif
    }

    status = NtWaitForSingleObject(handle_forwarder_recv_data_client, false, NULL);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] forwarder_client NtWaitForSingleObject forwarder_recv_data_client error: %x\n", status);
#endif
    }

    status = NtWaitForSingleObject(handle_forwarder_send_data_client, false, NULL);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] forwarder_client NtWaitForSingleObject forwarder_send_data_client error: %x\n", status);
#endif
    }

    NtClose(handle_forwarder_recv_data_client);
    NtClose(handle_forwarder_send_data_client);
}
...
void client_worker(struct function_args *args)
{
    struct client_data *client = (struct client_data *)args->args;
    struct map_node_thread *thread_client_worker = NULL;

    do_socks5_connection_client(client);

    free_map_client_receive_message(client->m_client_receive_message, client->mutex_m_client_receive_message);
    free_queue(client->socks5_message_queue);
    delete_spider_node(tree_client, mutex_tree_client, client->client_id);

    thread_client_worker = search_map_node_thread(m_thread, args->handle);
    ...
    {
#ifdef _DEBUG
        printf("[-] client_worker cannot close handle\n");
#endif
    }
...
void listen_client(struct function_args *args)
{
    struct client_data *client_listen = (struct client_data *)args->args;
    struct map_node_thread *thread = NULL;
    ...
    uint16_t port_num = 0;
    SOCKET client_listen_sock = -1;
    SOCKET client_sock = -1;
    BOOL reuse = 1;
    int client_addr_length = sizeof(struct sockaddr_in);
    int client_addr6_length = sizeof(struct sockaddr_in6);
    char *client_ip = NULL;
    ...
    if(strchr(client_listen->client_ip, ':') == NULL)   // ipv4
    {
        ...
        {
            printf("[-] listen_client socket error: %d\n", WSAGetLastError());
        ...
        reuse = 1;
        ret = setsockopt(client_listen_sock, SOL_SOCKET, SO_REUSEADDR, (const char *)&reuse, sizeof(int));
        if(ret == SOCKET_ERROR)
        {
            printf("[-] listen_client setsockopt error: %d\n", WSAGetLastError());
        ...
        // listen
        ret = listen(client_listen_sock, 5);
        if(ret == SOCKET_ERROR)
        {
            printf("[-] listen_client listen error: %d\n", WSAGetLastError());
        ...
        do
        {
            ...
            ret = insert_spider_node(tree_client, mutex_tree_client, client_listen_id, client_listen);
        }while(ret != 0);
        ...
        while(1)
        {
            ...
            create_map_client_receive_message(&client->m_client_receive_message, &client->mutex_m_client_receive_message);
            ...
            do
            {
                ...
                ret = insert_spider_node(tree_client, mutex_tree_client, client_id, client);
            }while(ret != 0);
            ...
            function_args = (struct function_args *)calloc(1, sizeof(struct function_args));
            function_args->args = (void *)client;
            start_thread(m_thread, (void *)client_worker, (void *)function_args);
            millisleep(100);
        }
    }else   // ipv6
    {
...
exit_0:
    ...
    delete_spider_node(tree_client, mutex_tree_client, client_listen_id);
    ...
    {
#ifdef _DEBUG
        printf("[-] listen_client cannot close handle\n");
#endif
    }
}
