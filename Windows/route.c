...
void insert_route(struct avlt_node_route **node, const char *ip_address, struct route_data *data)
{
    ...
    status = NtWaitForSingleObject(mutex_routing_table, false, NULL);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] insert_route NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    *node = insert_avlt_node_route(*node, ip_address, data);
    ...
    status = NtReleaseMutant(mutex_routing_table, &previousCount_mutex);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] insert_route NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}
...
struct avlt_node_route *search_route(struct avlt_node_route *root, const char *ip_address)
{
    ...
    {
#ifdef _DEBUG
        printf("[-] search_route NtWaitForSingleObject error: %x\n", status);
#endif
        return NULL;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] search_route NtReleaseMutant error: %x\n", status);
#endif
        return NULL;
    }
...
void delete_route(struct avlt_node_route **root, const char *ip_address)
{
    ...
    {
#ifdef _DEBUG
        printf("[-] delete_route NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    *root = delete_avlt_node_route(*root, ip_address);
    ...
    {
#ifdef _DEBUG
        printf("[-] delete_route NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}
...
void register_dead_route(struct avlt_node_route *root, uint32_t pipe_id)
{
    ...
    {
#ifdef _DEBUG
        printf("[-] register_dead_route NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] register_dead_route NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}
...
void free_routing_table(struct avlt_node_route *root)
{
    ...
    {
#ifdef _DEBUG
        printf("[-] free_routing_table NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] free_routing_table NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
}
...
int init_routing_table()
{
    ...
    status = NtCreateMutant(&mutex_routing_table, 0x1F0001, NULL, false);
    if(!NT_SUCCESS(status))
    {
#ifdef _DEBUG
        printf("[-] init_routing_table NtCreateMutant error: %x\n", status);
#endif
        return -1;
    }
...
void print_routing_table()
{
    ...
    {
#ifdef _DEBUG
        printf("[-] print_routing_table NtWaitForSingleObject error: %x\n", status);
#endif
        return;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] print_routing_table NtReleaseMutant error: %x\n", status);
#endif
        return;
    }
...
void send_routing_table()
{
    ...
    {
#ifdef _DEBUG
        printf("[-] send_routing_table NtWaitForSingleObject error: %x\n", status);
#endif
        goto exit;
    }
    ...
    {
#ifdef _DEBUG
        printf("[-] send_routing_table NtReleaseMutant error: %x\n", status);
#endif
        goto exit;
    }
    ...
    send_routing_table_inorder_tree_rbt_node_pipe(tree_pipe, mutex_tree_pipe, buffer, buffer_length);
...
error:
    ...
    {
#ifdef _DEBUG
        printf("[-] update_routing_table cannot close handle\n");
#endif
    }
...
void delete_routing_table(struct function_args *args)
{
    ...
    while(1)
    {
        ...
        {
#ifdef _DEBUG
            printf("[-] delete_routing_table NtWaitForSingleObject error: %x\n", status);
#endif
            goto error;
    }
        ...
        {
#ifdef _DEBUG
            printf("[-] delete_routing_table NtReleaseMutant error: %x\n", status);
#endif
            goto error;
        }
...
error:
    ...
    {
#ifdef _DEBUG
        printf("[-] delete_routing_table cannot close handle\n");
#endif
    }
