# tinyspider (Linux aarch64)

socks5 proxy tunnel tool

## Installation
### Install dependencies
- aarch64 architecture, 64bit, little endian
- gcc (c99)
- make
