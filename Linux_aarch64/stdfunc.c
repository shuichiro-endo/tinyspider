...
extern long syscall(long a, long b, long c, long d, long e, long f, long n);
...
ssize_t read(int fd, void *buffer, size_t count)
{
    ...
    ret = syscall(fd, (long)buffer, count, 0, 0, 0, SYS_read);
    if(ret < 0)
    {
        return ret;
    }
...
ssize_t write(int fd, void *buffer, size_t length)
{
    ...
    while(offset < length)
    {
        ret = syscall(fd, (long)((char *)buffer + offset), length - offset, 0, 0, 0, SYS_write);
        if(ret < 0)
        {
            return ret;
        }
...
int open(const char *pathname, int flags)
{
    ...
    fd = syscall(0, (long)pathname, flags, 0, 0, 0, SYS_openat);
...
int close(int fd)
{
    ...
    ret = syscall(fd, 0, 0, 0, 0, 0, SYS_close);
...
int mprotect(void *addr, size_t len, int prot)
{
    ...
    ret = syscall((long)addr, len, prot, 0, 0, 0, SYS_mprotect);
...
int rt_sigaction(int signum, const struct sigaction *act, struct sigaction *oldact, size_t sigsetsize)
{
    ...
    ret = syscall(signum, (long)&kact, (long)&koldact, sigsetsize, 0, 0, SYS_rt_sigaction);
...
int select(int nfds, struct fd_set *readfds, struct fd_set *writefds, struct fd_set *exceptfds, struct timeval *timeout)
{
    ...
    ret = syscall(nfds, (long)readfds, (long)writefds, (long)exceptfds, (long)&ts, (long)0, SYS_pselect6);
...
pid_t getpid(void)
{
    ...
    ret = syscall(0, 0, 0, 0, 0, 0, SYS_getpid);
...
int socket(int domain, int type, int protocol)
{
    ...
    ret = syscall(domain, type, protocol, 0, 0, 0, SYS_socket);
...
int connect(int sockfd, const struct sockaddr *addr, socklen_t addrlen)
{
    ...
    ret = syscall(sockfd, (long)addr, addrlen, 0, 0, 0, SYS_connect);
...
int accept(int sockfd, struct sockaddr *addr, socklen_t *addrlen)
{
    ...
    ret = syscall(sockfd, (long)addr, (long)addrlen, 0, 0, 0, SYS_accept);
...
ssize_t sendto(int sockfd, const void *buf, size_t len, int flags, const struct sockaddr *dest_addr, socklen_t addrlen)
{
    ...
    ret = syscall(sockfd, (long)buf, len, flags, (long)dest_addr, addrlen, SYS_sendto);
...
ssize_t recvfrom(int sockfd, void *buf, size_t len, int flags, struct sockaddr *src_addr, socklen_t *addrlen)
{
    ...
    ret = syscall(sockfd, (long)buf, len, flags, (long)src_addr, (long)addrlen, SYS_recvfrom);
...
int shutdown(int sockfd, int how)
{
    ...
    ret = syscall(sockfd, how, 0, 0, 0, 0, SYS_shutdown);
...
int bind(int sockfd, const struct sockaddr *addr, socklen_t addrlen)
{
    ...
    ret = syscall(sockfd, (long)addr, addrlen, 0, 0, 0, SYS_bind);
...
int listen(int sockfd, int backlog)
{
    ...
    ret = syscall(sockfd, backlog, 0, 0, 0, 0, SYS_listen);
...
int setsockopt(int sockfd, int level, int optname, const void *optval, socklen_t optlen)
{
    ...
    ret = syscall(sockfd, level, optname, (long)optval, optlen, 0, SYS_setsockopt);
...
int getsockopt(int sockfd, int level, int optname, void *optval, socklen_t *optlen)
{
    ...
    ret = syscall(sockfd, level, optname, (long)optval, (long)optlen, 0, SYS_getsockopt);
...
{
    syscall(status, 0, 0, 0, 0, 0, SYS_exit);
...
int gettimeofday(timeval *tv, timezone *tz)
{
    ...
    ret = syscall((long)tv, (long)tz, 0, 0, 0, 0, SYS_gettimeofday);
...
pid_t setsid(void)
{
    ...
    ret = syscall(0, 0, 0, 0, 0, 0, SYS_setsid);
...
pid_t gettid(void)
{
    ...
    ret = syscall(0, 0, 0, 0, 0, 0, SYS_gettid);
...
{
    syscall(status, 0, 0, 0, 0, 0, SYS_exit_group);
...
int fcntl(int fd, int cmd, int arg)
{
    ...
    ret = syscall(fd, cmd, arg, 0, 0, 0, SYS_fcntl);
...
ssize_t getrandom(void *buf, size_t buflen, unsigned int flags)
{
    ...
    ret = syscall((long)buf, buflen, flags, 0, 0, 0, SYS_getrandom);
...
{
    syscall((long)addr, FUTEX_WAIT, value, (long)NULL, (long)NULL, 0, SYS_futex);
}

void futex_wake(__volatile__ int *addr, int value)
{
    syscall((long)addr, FUTEX_WAKE, value, (long)NULL, (long)NULL, 0, SYS_futex);
}
...
void millisleep(int ms)
{
    ...
    syscall((long)ts, (long)ts, 0, 0, 0, 0, SYS_nanosleep);
}
...
void *malloc(size_t size)
{
    ...
    ptr = (void *)syscall(0, total_size, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0, SYS_mmap);
    if(ptr == MAP_FAILED)
    {
        return NULL;
    }
...
void free(void *ptr)
{
    ...
    ret = syscall((long)((char *)ptr - sizeof(size_t)), block_size, 0, 0, 0, 0, SYS_munmap);
}
