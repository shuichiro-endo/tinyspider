...
struct semaphore sem_tree_pipe __attribute__((aligned(16)));
struct rbt_spider *tree_client = NULL;
struct semaphore sem_tree_client __attribute__((aligned(16)));
struct rbt_spider *tree_server = NULL;
struct semaphore sem_tree_server __attribute__((aligned(16)));
...
void init_tree_spider_node()
{
    semaphore_init(&sem_tree_pipe, 1);
    semaphore_init(&sem_tree_client, 1);
    semaphore_init(&sem_tree_server, 1);

    semaphore_wait(&sem_tree_pipe);
    init_rbt_spider(&tree_pipe);
    semaphore_post(&sem_tree_pipe);

    semaphore_wait(&sem_tree_client);
    init_rbt_spider(&tree_client);
    semaphore_post(&sem_tree_client);

    semaphore_wait(&sem_tree_server);
    init_rbt_spider(&tree_server);
    semaphore_post(&sem_tree_server);
}

int insert_spider_node(struct rbt_spider *tree, struct semaphore *sem, uint32_t id, void *data)
{
    struct rbt_node_spider *node = NULL;
...
struct rbt_node_spider *search_spider_node(struct rbt_spider *tree, struct semaphore *sem, uint32_t id)
{
    struct rbt_node_spider *node = NULL;
...
void delete_spider_node(struct rbt_spider *tree, struct semaphore *sem, uint32_t id)
{
    semaphore_wait(sem);
...
void send_routing_table_inorder_tree_rbt_node_pipe(struct rbt_spider *tree, struct semaphore *sem, char *buffer, int32_t buffer_length)
{
    semaphore_wait(sem);
...
void print_spider_node_pipe(struct rbt_spider *tree, struct semaphore *sem)
{
    printf("----------------------------------------------------------------------------------------------------- pipe -----------------------------------------------------------------------------------------------------\n");
...
void print_spider_node_client(struct rbt_spider *tree, struct semaphore *sem)
{
    printf("-------------------------------------------------------------------------------------------------------------------------------------------------------- client --------------------------------------------------------------------------------------------------------------------------------------------------------\n");
...
void print_spider_node_server(struct rbt_spider *tree, struct semaphore *sem)
{
    printf("---------------------------------------------------------------------------------------------------------------------------------------- server -----------------------------------------------------------------------------------------------------------------------------------------\n");
...
void free_rbt_tree_spider(struct rbt_spider *tree, struct semaphore *sem)
{
    semaphore_wait(sem);
