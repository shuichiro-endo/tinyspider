...
struct semaphore sem_routing_table __attribute__((aligned(16)));
...
void update_routing_table(tid_t thread_id, struct stack_head *stack)
{
...
void delete_routing_table(tid_t thread_id, struct stack_head *stack)
{
